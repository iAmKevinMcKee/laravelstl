<div class="bg-gray-300 fixed inset-0 flex items-center justify-center">
    <button class="absolute top-0 right-0 mt-20 mr-20 text-gray-700 text-xl flex items-center" wire:click="stopEditing">
    ...
    <div class="w-1/2 bg-white shadow-lg p-8 rounded">
        ...
        <div class="flex items-center justify-end">
            ...
            <button class="bg-blue-800 p-2 rounded focus:outline-none uppercase font-bold hover:bg-blue-600 text-white"
