<div>
    ...
    <div class="w-full flex mt-8">
        @if($hideCompleted)
            <button class="bg-blue-800 p-2 rounded-lg flex-1 mx-3 focus:outline-none uppercase font-bold" wire:click="$toggle('hideCompleted')"><i class="far fa-check-square mr-1"></i> Hide Completed Events</button>
        @else
            <button class="bg-blue-800 p-2 rounded-lg flex-1 mx-3 focus:outline-none uppercase font-bold" wire:click="$toggle('hideCompleted')"><i class="far fa-square mr-1"></i> Hide Completed Events</button>
        @endif
        @if($hideScheduled)
            <button class="bg-blue-800 p-2 rounded-lg flex-1 mx-3 focus:outline-none uppercase font-bold" wire:click="$toggle('hideScheduled')"><i class="far fa-check-square mr-1"></i> Hide Scheduled Events</button>
        @else
            <button class="bg-blue-800 p-2 rounded-lg flex-1 mx-3 focus:outline-none uppercase font-bold" wire:click="$toggle('hideScheduled')"><i class="far fa-square mr-1"></i> Hide Scheduled Events</button>
        @endif
        @if($hideUnscheduled)
            <button class="bg-blue-800 p-2 rounded-lg flex-1 mx-3 focus:outline-none uppercase font-bold" wire:click="$toggle('hideUnscheduled')"><i class="far fa-check-square mr-1"></i> Hide Unscheduled Events</button>
        @else
            <button class="bg-blue-800 p-2 rounded-lg flex-1 mx-3 focus:outline-none uppercase font-bold" wire:click="$toggle('hideUnscheduled')"><i class="far fa-square mr-1"></i> Hide Unscheduled Events</button>
        @endif
{{--            <button class="bg-blue-800 p-2 rounded-lg flex-1 mx-3 focus:outline-none uppercase font-bold"><i class="far fa-square mr-1"></i> Hide Completed Events</button>--}}
{{--        <button class="bg-blue-800 p-2 rounded-lg flex-1 mx-3 focus:outline-none uppercase font-bold"><i class="far fa-square mr-1"></i> Hide Unscheduled Events</button>--}}
    </div>
